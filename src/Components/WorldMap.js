...
export default function WorldMap(props){
  ...
  const handleClick = (e, countryCode) => {
      ...
      axios.get('https://corona.lmao.ninja/v2/countries/'+jvmCountries[countryCode].name+'?yesterday=true&strict=true&query').then((res)=> { 
        //console.log(res.data.active)
        //console.log(res.data.todayCases)
        imageurl= res.data
  ...
  return (
    ...
    <Grid container direction="column" justify="space-between" alignItems="center" spacing={0} style={{marginTop:80}}>
